        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionEndsAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmtpSenderEmail = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    SmtpSenderPasswordEncrypted = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailVerificationTokenSentAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    PendingEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PendingEmailTokenHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PendingEmailTokenExpiresAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSessions_RefreshTokenRevokedAt",
                table: "UserSessions",
